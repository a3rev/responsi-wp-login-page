...
class Responsi_WP_Login_Page_Upgrade
{
	...
	protected $plugin_key     = RESPONSI_WPLOGIN_KEY;
	protected $plugin_version = RESPONSI_WPLOGIN_VERSION;
	protected $plugin_path    = RESPONSI_WPLOGIN_NAME;
...
new Responsi_WP_Login_Page_Upgrade();
